#!/usr/bin/env python3
"""
Generate sfx_failure.wav - descending tone for incomplete/failed mission.
Duration: ~0.30 seconds
Frequency sweep: 500 Hz → 350 Hz
...
output_path = os.path.join(BASE_DIR, "assets", "audio", "sfx_failure.wav")
